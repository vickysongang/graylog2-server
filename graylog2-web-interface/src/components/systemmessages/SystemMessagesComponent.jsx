      ...
      <Row className="content">
        <Col md={12}>
          ...
          <p className="description">
            System messages are generated by BAM-server nodes on certain events that may be interesting for
            the BAM administrators. You don't need to actively act upon any message in here because notifications
